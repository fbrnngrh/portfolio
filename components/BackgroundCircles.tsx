...
export default function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="rounded-full border border-[#333333] opacity-25 h-[300px] w-[300px] absolute mt-52" />
      <div className="rounded-full border border-[#333333] opacity-30  h-[500px] w-[500px] absolute mt-52" />
